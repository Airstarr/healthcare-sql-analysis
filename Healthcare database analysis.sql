...
SELECT DIAGNOSIS_ID, DIAGNOSIS_CODE, COUNT(APPOINTMENT_ID) AS NO_OF_APPOINTMENTS
FROM DIAGNOSES
...
SELECT P.PATIENT_ID, P.FIRST_NAME, P.LAST_NAME, COUNT(DIAGNOSIS_ID) AS NO_OF_DIAGNOSIS
FROM DIAGNOSES D
...
SELECT D.DOCTOR_ID, D.DOCTOR_NAME, COUNT(A.APPOINTMENT_ID) as NO_OF_NO_SHOW_APPOINTMENTS
FROM DOCTORS D
JOIN APPOINTMENTS A ON A.DOCTOR_ID = D.DOCTOR_ID
WHERE A.STATUS = 'No-show'
GROUP BY D.DOCTOR_ID
ORDER BY NO_OF_NO_SHOW_APPOINTMENTS ASC
LIMIT 1
